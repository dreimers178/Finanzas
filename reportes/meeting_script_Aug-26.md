...
### Quick-reference numbers (as of Aug 31)

| | Portal Uploads | Tesorio Tasks |
|---|---|---|
| Volume (Aug) | 46 uploads / 41 resolved | 53 created / 50 completed |
| Avg. resolution | 0.9 days | 1.1 days |
| Same-day | 85% | 74% |
| Open at month-end | — | 4 |
| Trend (avg days) | 2.8 → 2.9 → 0.9 | 5.2 → 2.0 → 1.1 |

**Platforms most used (Aug):** Coupa 20 · Ariba 12 · Other 5 · Taulia 4 · Oracle 3 · URL 2
**Slowest:** URL cases ≈ 8 days vs. < 1 day for Coupa/Ariba → access-setup opportunity.
